...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      ...
      <Link
        to="/process"
        className="mt-8 inline-block rounded-full border border-red-600 px-12 py-3 text-sm font-medium text-white hover:bg-red-600 hover:text-white focus:outline-none focus:ring active:bg-red-500"
      >
        Get Started
      </Link>
    </div>
